...
1. I've been self-hosting an email newsletter from home. With power outages, internet outages, home server outages, the server downtime was getting to be a bit much for my taste. I wanted to deploy to the cloud for better uptime.
...
I like hetzner-k3s, but... I wish it could modify existing clusters. There were a couple times when my cluster wasn't doing what I wanted. I edited my `cluster.yaml` file, but there was no way to have hetzner-k3s update my existing cluster. If I knew how to assign Primary IPs in Hetzner, that could be another way to solve this problem.
:::
