...
I'll be completely honest - I found synching my Fastmail contacts and calendars with my Android phone clunky and confusing. Android doesn't natively support the CalDAV and CardDAV protocols used to sync calendars and contacts. That's where [DAVx⁵](https://www.davx5.com/) comes in - it's an open-source sync adapter that connects your Android device to any CalDAV/CardDAV server, including Fastmail. I'm writing the guide I would have wanted if I was setting up DAVx5 for the first time to sync with a Fastmail account.
...
The initial sync can take a while. Try to be patient, it took many minutes to sync for me. This gets your data into Android Storage, now you need to configure your apps to read and write to the right place. I'm currently using Google Contacts and Fossify Calendar but let me know if there are better apps out there (Fossify Contacts looks popular).
