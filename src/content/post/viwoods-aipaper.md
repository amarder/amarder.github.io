...
The stylus that comes with the Viwoods AiPaper is okay. I think the Apple Pencil is an excellent input device (great weight, smooth writing experience, and it feels solid and good in the hand). I would give the Apple Pencil an "A" and the Viwoods stylus a "B". My main complaint with the Viwoods stylus is that the eraser and button rattle around a bit. It doesn't feel solid. I tried (and returned) two other styluses:
...
- **Battery**. The stylus doesn't use electricity. The Apple Pencil is a drain on the iPad battery. I have to charge the iPad daily, and if I leave the pencil attached when storing the iPad then the iPad battery will be completely drained when I come back to it. Battery life on the AiPaper is great.
...
- **Weight**. The AiPaper is lightweight and thin, which is nice. My iPad is a little bulky (the new iPad Pro is only 444 grams, the AiPaper is 370 grams).

- **Discreet**. I like the monochrome screen. If I take notes with the AiPaper in a meeting, folks will be less concerned that I'm multitasking or not paying attention to the meeting.
