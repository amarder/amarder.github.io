...
- **Added** [GrapheneOS](/grapheneos) post
- **Updated** [app defaults](/defaults)
    - Android Contacts → Fossify Contacts
    - Android Messages → QUIK
    - Qobuz → TIDAL

## 2026-03-16

- **Added** [DAVx⁵](/fastmail/davx5) post

## 2026-03-09

- **Updated** [app defaults](/defaults)
    - Obsidian Tasks → Super Productivity
    - Spotify → Qobuz
    - Started using linkding

## 2026-03-07

- **Added** [Super Productivity](/super-productivity) post

## 2026-02-28

- **Added** [AI and Steroids](/steroids) post

## 2026-02-26

- **Added** [Uptime Kuma](/uptime-kuma) post

## 2026-02-21

- **Added** [Ghost](/ghost) post
- **Deprecated** [Keila](/keila) and [listmonk](/listmonk) posts
...
- **Removed** giscus comments section
- **Added** links for external comments

## 2026-02-10

- **Added** [Keila](/keila) post

## 2026-02-04

- **Added** [Fastmail](/fastmail) post
- **Updated** [app defaults](/defaults) - replaced Proton Mail with Fastmail
...
- **Updated** [solar](/solar) post
    - Cleaned up graphs
    - Added IRR and NPV calculations

## 2026-01-08

- **Added** [solar](/solar) post
