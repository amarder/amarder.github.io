...
1.  Privacy. "Proton Mail is a secure email service that's powered by our community, not surveillance capitalism."
    I don't want my email provider reading my emails.

2.  Great support for custom domains.
    Send a message to [andrew@andrewmarder.net](mailto:andrew@andrewmarder.net), and it will end up in my Proton Mailbox.
    I've been very happy with their custom domain support.
    If Proton ever does something I don't like, or a new email provider does something awesome, I can keep my email address and move it to a new provider.
...
Proton's support for photos would have been cool **if** the photos were saved directly to Proton Drive and the files could be manipulated there. That would have worked beautifully with [digiKam](https://www.digikam.org/). After some tinkering, I decided self-hosting [Immich](https://immich.app/) would be the best photo solution for me.
...
- If you're looking for a VPN, I wholeheartedly endorse Proton VPN. I think it's great.

- If you're looking for an email provider committed to your privacy, I think Proton Mail is the least bad option out there.

If after that rousing sales pitch you're still interested in trying Proton products, feel free to use [my referral link](https://pr.tn/ref/FE40Q0S4).
